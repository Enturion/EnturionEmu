...
void World::LoadConfigSettings(bool reload)
{
    ...
    SetMotd(ConfigMgr::GetStringDefault("Motd", "Welcome to a SkyFire server."));
    ...
    m_int_configs[CONFIG_MAX_RECRUIT_A_FRIEND_BONUS_PLAYER_LEVEL_DIFFERENCE] = ConfigMgr::GetIntDefault("RecruitAFriend.MaxDifference", 3);
    ...
    m_int_configs[CONFIG_GM_DEV_TAG_ENABLE]     = ConfigMgr::GetIntDefault("GM.EnableDevTag", 0);
    m_int_configs[CONFIG_GM_DEV_TAG_LEVEL]      = ConfigMgr::GetIntDefault("GM.DevTagGMLevel", 100);
    ...
    m_int_configs[CONFIG_GM_LEVEL_ALLOW_ACHIEVEMENTS] = ConfigMgr::GetIntDefault("GM.AllowAchievementGain.Level", 4);
    ...
    std::string ignoreMapIds = ConfigMgr::GetStringDefault("vmap.ignoreMapIds", "");
