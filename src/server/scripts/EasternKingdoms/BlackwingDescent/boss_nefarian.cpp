		...
		struct boss_nefarian2AI : public ScriptedAI
		{
			...
			void UpdateAI(const uint32 diff)
			{
				...
				if (Shadowflame_Barrage_Timer <= diff)
				{
					...
					Shadowflame_Barrage_Timer -= diff;			
				...
				if (Children_of_Deathwing_Timer <= diff)
				{
					...
					Children_of_Deathwing_Timer -= diff;
				...
				if (Shadow_of_Cowardige_Timer <= diff)
				{
					...
					Shadow_of_Cowardige_Timer -= diff;
